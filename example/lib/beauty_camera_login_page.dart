...
import 'package:zego_faceunity_plugin_example/beauty_camera_page.dart';

class BeautyCameraLoginPage extends StatefulWidget {
  @override
  _BeautyCameraLoginPageState createState() => new _BeautyCameraLoginPageState();
}

class _BeautyCameraLoginPageState extends State<BeautyCameraLoginPage> {
  ...
  void _loginRoom() {
    ...
    Navigator.of(context).push(MaterialPageRoute(builder: (BuildContext context) {
      ...
      return BeautyCameraPage(screenWidthPx, screenHeightPx);
